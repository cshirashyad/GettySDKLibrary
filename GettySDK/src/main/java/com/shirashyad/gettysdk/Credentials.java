...
public class Credentials {
    ...
    public Token GetAccessToken() throws com.shirashyad.gettysdk.SdkException {
        ...
        com.shirashyad.gettysdk.WebHelper helper = new com.shirashyad.gettysdk.WebHelper(this, baseUrl);
        ...
        try {
            ...
            e.printStackTrace();
            throw new com.shirashyad.gettysdk.SdkException("Unable to get access token. Probably invalid credentials.");
        }
    }
    ...
    public Map<String,String> GetCredentialsDictionary()
    {
        ...
        if (!com.shirashyad.gettysdk.StringHelper.isNullOrEmpty(ApiKey))
        {
            dict.put(ClientIdKey, ApiKey);
        }

        if (!com.shirashyad.gettysdk.StringHelper.isNullOrEmpty(ApiSecret))
        {
            dict.put(ClientSecretKey, ApiSecret);
        }

        if (!com.shirashyad.gettysdk.StringHelper.isNullOrEmpty(UserName))
        {
            dict.put(UsernameKey, UserName);
        }

        if (!com.shirashyad.gettysdk.StringHelper.isNullOrEmpty(UserPassword))
        {
